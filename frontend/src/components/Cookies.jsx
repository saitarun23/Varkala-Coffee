...
import cookie1 from '../assets/images/product1.jpeg';
import cookie2 from '../assets/images/product4.jpeg';
import cookie3 from '../assets/images/product2.jpeg'; 
import cookie4 from '../assets/images/product3.jpeg';
  ...
  const collection = [
    {
      ...
      roast: "Classic",
      notes: "Rich Chocolate, Butter, Vanilla",
      price: "₹350",
      image: cookie1
    },
    {
      ...
      roast: "Artisan",
      notes: "Crunchy Almonds, Honey, Light Spice",
      price: "₹400",
      image: cookie2
    },
    {
      ...
      roast: "Premium",
      notes: "Dark Chocolate, Fudgy, Nutty",
      price: "₹300",
      image: cookie3
    },
    {
      id: "4",
      name: "Cardamom & Pistachios",
      roast: "Specialty",
      notes: "Aromatic Cardamom, Green Pistachios, Floral",
      price: "₹450",
      image: cookie4
    }
  ];
      ...
      <section className="sp-fullscreen-hero">
        ...
        <div className="sp-hero-content-center">
          <h1 className="sp-hero-title-main">
            ...
            <span className="title-outline">Cookies</span>
          </h1>
        </div>
      </section>
