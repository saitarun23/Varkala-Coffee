...
const productDatabase = {
  "1": { 
    ...
    basePrice: 850, 
    images: [prod1, prod4, prod2, prod6], 
      ...
      <div className="pdp-main-container">
        ...
        <div className="pdp-info-section">
          ...
          <div className="variant-selector">
            <h4 className="variant-label">Preparation Type: <span>{selectedGrind}</span></h4>
            <div className="variant-options">
              {['Whole Beans', 'French Press', 'Filter Coffee', 'Espresso'].map((grind) => (
                <button 
                  key={grind}
