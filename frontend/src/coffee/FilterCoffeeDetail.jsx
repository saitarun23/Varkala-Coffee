...
import { ShoppingBag, ArrowLeft, Minus, Plus, Truck, RotateCcw, ShieldCheck, Star, Sparkles, Leaf, Award , PackageCheck, Filter} from 'lucide-react';
// Import local images
...
const FilterCoffeeDetail = () => {
  const { id } = useParams();
  const product = FilterCoffeeDatabase[id] || FilterCoffeeDatabase["default"];
...
export default FilterCoffeeDetail;